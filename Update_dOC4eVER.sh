...
case "$REPLY" in 
 ...
 echo ""
    ...
    wget http://46.175.149.24/xtreamui/ubuntu18.04-20.04/XtreamUI-V22F-CK1/update.zip -O /tmp/update.zip -o /dev/null

    wget https://raw.githubusercontent.com/PlusmasTV/XtreamUI-V22F-CK1-Ubuntu-18-20-22/main/start_services.sh -O /tmp/start_services.sh -o /dev/null
    #! clear
 echo ""
 echo ""
