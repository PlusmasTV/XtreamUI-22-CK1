...
while getopts ":t:a:p:o:c:r:e:m:s:h:" option; do
    case "${option}" in
        ...
        h)
            echo "help usage"
			echo "curl -L https://raw.githubusercontent.com/PlusmasTV/XtreamUI-V22F-CK1-Ubuntu-18-20-22/main/install.sh | sudo bash -s -- -a adminusername -t timezone -p adminpassord -o adminaccesport -c clientaccesport -r apacheport -e email -m mysqlpassword -s yes"
			...
			echo "full exemple"
			echo "curl -L https://raw.githubusercontent.com/PlusmasTV/XtreamUI-V22F-CK1-Ubuntu-18-20-22/main/install.sh | bash -s -- -a admin -t Europe/Paris -p admin -o 25500 -c 80 -r 8080 -e admin@example.com -m mysqlpassword -s yes"
...
wget -qO- https://raw.githubusercontent.com/PlusmasTV/XtreamUI-V22F-CK1-Ubuntu-18-20-22/main/ubuntu/depbuild.sh | bash
...
modifyNginx()
END
wget -qO install.sql https://raw.githubusercontent.com/PlusmasTV/XtreamUI-V22F-CK1-Ubuntu-18-20-22/main/update_reg_users.py
...
echo " "
echo " "
wget -q -O /tmp/update.zip http://46.175.149.24/xtreamui/ubuntu18.04-20.04/XtreamUI-V22F-CK41/update.zip
...
wget https://raw.githubusercontent.com/PlusmasTV/XtreamUI-V22F-CK1-Ubuntu-18-20-22/main/balancer.php -O /home/xtreamcodes/iptv_xtream_codes/crons/balancer.php
wget https://raw.githubusercontent.com/PlusmasTV/XtreamUI-V22F-CK1-Ubuntu-18-20-22/main/balancer.sh -O /home/xtreamcodes/iptv_xtream_codes/pytools/balancer.sh
chmod +x /home/xtreamcodes/iptv_xtream_codes/pytools/balancer.sh
rm -f /home/xtreamcodes/iptv_xtream_codes/start_services.sh
wget https://raw.githubusercontent.com/PlusmasTV/XtreamUI-V22F-CK1-Ubuntu-18-20-22/main/start_services.sh -O /home/xtreamcodes/iptv_xtream_codes/start_services.sh
chmod +x /home/xtreamcodes/iptv_xtream_codes/start_services.sh
if [[ "$OS" = "CentOs" || "$OS" = "Fedora" || "$OS" = "Centos Stream" ]]; then
echo " "
